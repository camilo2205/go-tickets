<a
    {{ $attributes->merge(['class' => 'inline-flex items-center px-4 py-1.5 bg-blue-400 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-600 active:bg-blue-800 focus:outline-none focus:border-blue-800 focus:ring ring-blue-200 disabled:opacity-25 transition ease-in-out duration-150']) }}>
