<x-app-layout>
    ...
    <form action="{{ route('clientes.update', $cliente->id) }}" method="post" class="flex flex-row flex-wrap space-x-4 space-y-4">
        ...
        @method('PUT')
        <!-- NIT -->
        <div class="md:basis-1/6 basis-1/3">
        ...
        <!-- Nombre -->
        <div class="md:basis-1/4 basis-2/3">
        ...
        <!-- Dirección -->
        <div class="md:basis-5/12 basis-full">
        ...
        <!-- Teléfono -->
        <div class="md:basis-2/12 basis-4/12">
        ...
        <!-- Correo -->
        <div class="md:basis-1/4 basis-1/2">
