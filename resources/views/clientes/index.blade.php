        ...
        <tbody>
            @foreach ($clientes as $cliente)
                <tr>
                    ...
                    <td class="border border-slate-300 px-5 py-1">{{ $cliente->nombre }}</td>
                    <td class="border border-slate-300 px-5 py-1">{{ $cliente->telefono }}</td>
                    <td class="border border-slate-300 px-5 py-1">{{ $cliente->celular }}</td>
                    <td class="border border-slate-300 px-5 py-1">{{ $cliente->correo }}</td>
