<x-app-layout>
    ...
    <form action="{{ route('proyectos.store') }}" method="post" class="flex flex-row flex-wrap space-y-4"
        ...
        <div class="md:basis-5/12 px-2">
            ...
            <x-input id="nombre" class="block w-full" type="text" name="nombre" :value="old('nombre')"></x-input>
            @error('nombre')
