<x-app-layout>
        ...
        <div class="flex flex-row content-end">
            <div class="basis-1/3">
                <span class="text-sm text-gray-800"><a class="underline"
                        href="{{ route('funcionarios.index') }}">Funcionarios</a> / <span class="font-bold">Crear</span>
                </span>
            </div>
    ...
    <form action="{{ route('funcionarios.store') }}" method="post" class="flex flex-row flex-wrap space-y-4">
        @csrf
        ...
        <div class="md:basis-1/6 basis-1/3 px-2">
            ...
            <x-input id="identificacion" class="block mt-1 w-full" type="text" name="identificacion" :value="old('identificacion')" autofocus />
        ...
        <div class="md:basis-3/12 basis-2/3 px-2">
            ...
            <x-input id="cargo" class="block mt-1 w-full" type="text" name="cargo" :value="old('cargo')" />
            @error('cargo')
                <x-small>{{ $message }}</x-small>
            @enderror
        </div>
